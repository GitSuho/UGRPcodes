...
while(1)
    for i = 2:101
        %use Runge-Kutta method and predict next position
        P(i, :) = RKn([OrbEqu(theta_curr), P(i-1,3:4)], @lag, dt, ord);    
        %Error estimation according to analytic solution
